...
define Profile/SF16A18-DF1A
	NAME:= FREEIRIS DF1A Rev2
	PACKAGES:=\
		iperf \
...
define Profile/SF16A18-DF1A/Description
	Support for freeiris opensource df1a boards
endef

define Profile/SF16A18-DF1A/Config
...
$(eval $(call Profile,SF16A18-DF1A))
